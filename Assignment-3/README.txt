...
After running the above script, it creates a berp-out.txt file containing the predicted tags for the test
sentences. The format is same as the training file i.e "word <tab> tag".
